        ...
        (e) => {
            if (element) {
                if (rightResize === "right" && element !== undefined) {
                    ...
                    const width = original_width - (e.pageX - original_mouse_x);
                    if (width > minimum_size) {
                        console.log(leftWidth + (e.pageX - original_mouse_x)); //tvarkyti
                    
                        // console.log(e.target.offsetParent.getBoundingClientRect().right-)
                        element.style.width = width + "px";
                        element.style.left = leftWidth === null ? e.pageX - original_mouse_x + "px" : leftWidth - (e.pageX - original_mouse_x)+ "px";
                    }
                }
            }
        },
